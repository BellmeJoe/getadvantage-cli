...
export function printGateUsage() {
  ...
  console.error("  Not in published getadvantage@0.14.2. Not live as a request interceptor.");
}
...
export function printGateHelp() {
  ...
  console.log("Not in published getadvantage@0.14.2. Not live as a request interceptor.");
}
