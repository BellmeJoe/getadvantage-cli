...
| 0.9.x | ICP stack-fit: Vite+React+Supabase **client orientation map** + dogfood reliability repair (evidence-only; candidate on 0.10.0) | **Candidate** (`4001a58` / pre-audit — not LIVE; repair on `11e41e4`) |
